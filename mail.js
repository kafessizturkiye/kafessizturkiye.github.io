...
const subjects = ['kafese hayır', 'eziyete karşıyım','kafes eziyetine karşıyım', 'Kafeslere Hayır', 'Kafesleri terk edin',
    'Yumurta kullanımınız', 'Kafeslere hayır', 'kafese son', 'Eziyet son bulsun', 'Hayvan eziyeti', 'hayvan eziyeti', 'eziyet bitsin', 'hayvanlara eziyet bitsin','taahhüt verin','kafes yumurtasını bırakın','Kafes yumurtasını bırakın', 'Hayvana eziyet', ' tavuklara özgürlük', 'Yumurtalar', 'yumurta', 'Kafeslere karşıyız', 'kafese karşıyım', 'kafese karşıyız',
    ...
    'Kafes eziyeti', 'Lütfen', 'Doğru olanı yapın', 'kafessiz yumurta', 'Kafesleri bırakın', 'kafesleri bırak', 'Kafesleri terk edin', 'Kafeslere dur deyin', 'eziyet son bulsun', 'eziyet', 'hayvanları düşünün ', 'eziyete son','eziyete son verin ','kafes yumurtası satmayın','Kafes yumurtası satmayın','Kafessiz bir Türkiye','yumurtalarınız','şikayet',' ',' ',' ',' ',' ',  ];
