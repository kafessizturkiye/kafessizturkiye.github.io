...
const subjects = ['kafese hayır', 'eziyete karşıyım','kafes eziyetine karşıyım', 'Kafeslere Hayır', 'Kafesleri terk edin',
    ...
    'Kafes eziyeti', 'Lütfen', 'Doğru olanı yapın', 'kafessiz yumurta', 'Kafesleri bırakın', 'kafesleri bırak', 'Kafesleri terk edin', 'Kafeslere dur deyin', 'eziyet son bulsun', 'eziyet', 'hayvanları düşünün ', 'eziyete son','eziyete son verin ','kafes yumurtası satmayın','Kafes yumurtası satmayın','Kafessiz bir Türkiye','yumurtalarınız',' ',' ',' ',' ',' ',' ',  ];
